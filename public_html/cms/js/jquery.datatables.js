	...
	$.fn.dataTable = function( oInit )
	{
		...
		function classSettings ()
		{
			...
			this.oLanguage = {
				...
				"sZeroRecords": "Sem resultados relacionados",
				"sEmptyTable": "Sem informações",
		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
			...
			sSearchStr = (sSearchStr.indexOf('_INPUT_') !== -1) ?
			  sSearchStr.replace('_INPUT_', '<input type="text" placeholder="Busca..." />') :
			  sSearchStr==="" ? '<input type="text" placeholder="Busca..." />' : sSearchStr+' <input type="text" placeholder="Busca..." />';
